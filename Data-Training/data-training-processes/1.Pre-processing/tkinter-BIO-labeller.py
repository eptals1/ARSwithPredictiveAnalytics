...
class EntityLabeler:
    def __init__(self, master):
        ...
        # Entity types
        self.entity_types = ["B-AGE", "I-AGE", "B-GENDER", "I-GENDER", "B-ADDRESS", "I-ADDRESS", "B-SKILL", "I-SKILL", "B-EDUCATION", "I-EDUCATION", "B-EXPERIENCE", "I-EXPERIENCE", "B-CERTIFICATION", "I-CERTIFICATION", "O"]
    ...
    def load_data(self):
        try:
            ...
            csv_path = "ARSwithPredictiveAnalytics-DataTraining/output/dataset/resumes.csv"
    ...
    def load_current_resume(self):
        if self.current_resume_idx < len(self.df):
            text = self.df.iloc[self.current_resume_idx]['text']

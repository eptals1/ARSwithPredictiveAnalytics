...
xgb_model.load_model("C:/Users/Acer/Desktop/Talaba,Ephraim/ARSwithPredictiveAnalytics/Data-Training/xgboost_resume_classifier.json")  # Load the JSON model
...
def score_resumes():
    ...
    for resume_file in resumes:
        ...
        rank_score = np.random.uniform(0.1, 0.9)  # Placeholder for actual rank scoring logic
        final_score = (jaccard_score_value + rank_score) / 2  # Averaging both scores

        scores.append({"resume": resume_file.filename, "score": final_score})
    ...
    #     scores.append({"resume": resume_file.filename, "score": jaccard_score_value})
